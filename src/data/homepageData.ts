...
export const about_react = `I am web developer focused on React Js and the most recently
...
react-hook-form, react-query and NestJs for server side rendering. I use Mongoose or Sequelize
